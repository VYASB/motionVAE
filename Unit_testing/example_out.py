...
import example_code as lstm_encoder_decoder
...
plt.savefig('D:/ShapeShifter23/motionVAE/outputs/synthetic_time_series.png')
...
plt.tight_layout
plt.savefig('D:/ShapeShifter23/motionVAE/outputs/train_test_split.png')
...
plt.tight_layout() 
plt.savefig('D:/ShapeShifter23/motionVAE/outputs/windowed_data.png')
