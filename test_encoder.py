...
class MotionEncoder(nn.Module):
    ...
    def forward(self, motion):
        ...
        a, (final_hidden_state, b) = self.lstm(motion, (hidden_state, cell_state))
        print(a.shape, final_hidden_state.shape, b.shape)
        ...
        return mu, var, latent_representation
...
class MotionDecoder(nn.Module):
    ...
    def forward(self, latent_representation):
        ...
        hidden_state = hidden_state.unsqueeze(0).expand(1, batch_size, self.hidden_dim)
...
decoder = MotionDecoder(latent_dim, hidden_dim, input_dim, seq_len)
...
mu, var, latent_representation = encoder(motion_data)
motion_seq = decoder(latent_representation)
